  ...
  <div>
    ...
    <div v-else class="h-screen relative">
      ...
      <div class="relative h-full">
        ...
        <div class="HomePageTitles info flex flex-col items-center justify-center h-screen relative">
          <div class="container text-left p-1 lg:p-20">
            ...
            >
              <!-- Title -->
              <div class="Title ">
               <h1 class="text-5xl">KEESHA AGYEI</h1>
               <p>Portfolio DJ & Graphic Design</p>
              </div>
              <div class="relative">
